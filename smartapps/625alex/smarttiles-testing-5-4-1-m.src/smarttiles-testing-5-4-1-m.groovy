 ...
 */
definition(
    name: "SmartTiles TESTING ${appVersion()}-${appStream()}",
    namespace: "625alex",
    author: "Alex Malikov",
...
.thermostatHeat {background-color: #333333} /*teal*/
.thermostatCool {background-color: #333333} /*teal*/
...
.dashboard {background-color: #333333;} /* red */
.history {background-color:#333333} /*dropcam grey*/

.switch.active .icon i.active {color:#FFFF00}
...
.presence.active .icon i.active {color:#59FF00}

.temperature[data-value='105°'] .icon {color: #8B0000}
.temperature[data-value='104°'] .icon {color: #8B0000}
.temperature[data-value='103°'] .icon {color: #8B0000}
.temperature[data-value='102°'] .icon {color: #8B0000}
.temperature[data-value='101°'] .icon {color: #8B0000}
.temperature[data-value='100°'] .icon {color: #8B0000}
.temperature[data-value='99°'] .icon {color: #8B0000}
.temperature[data-value='98°'] .icon {color: #8B0000}
.temperature[data-value='97°'] .icon {color: #8B0000}
.temperature[data-value='96°'] .icon {color: #8B0000}
.temperature[data-value='95°'] .icon {color: #8B0000}
.temperature[data-value='94°'] .icon {color: #8B0000}
.temperature[data-value='93°'] .icon {color: #8B0000}
.temperature[data-value='92°'] .icon {color: #FF0000}
.temperature[data-value='91°'] .icon {color: #FF0000}
.temperature[data-value='90°'] .icon {color: #FF0000}
.temperature[data-value='89°'] .icon {color: #FF0000}
.temperature[data-value='88°'] .icon {color: #FF0000}
.temperature[data-value='87°'] .icon {color: #FF0000}
.temperature[data-value='86°'] .icon {color: #FF0000}
.temperature[data-value='85°'] .icon {color: #D2691E}
.temperature[data-value='84°'] .icon {color: #D2691E}
.temperature[data-value='83°'] .icon {color: #D2691E}
.temperature[data-value='82°'] .icon {color: #D2691E}
.temperature[data-value='81°'] .icon {color: #D2691E}
.temperature[data-value='80°'] .icon {color: #D2691E}
.temperature[data-value='79°'] .icon {color: #D2691E}
.temperature[data-value='78°'] .icon {color: #D2691E}
.temperature[data-value='77°'] .icon {color: #6b8e23}
.temperature[data-value='76°'] .icon {color: #6b8e23}
.temperature[data-value='75°'] .icon {color: #6b8e23}
.temperature[data-value='74°'] .icon {color: #6b8e23}
.temperature[data-value='73°'] .icon {color: #6b8e23}
.temperature[data-value='72°'] .icon {color: #6b8e23}
.temperature[data-value='71°'] .icon {color: #6b8e23}
.temperature[data-value='70°'] .icon {color: #6b8e23}
.temperature[data-value='69°'] .icon {color: #6b8e23}
.temperature[data-value='68°'] .icon {color: #6B8E23}
.temperature[data-value='67°'] .icon {color: #6B8E23}
.temperature[data-value='66°'] .icon {color: #6B8E23}
.temperature[data-value='65°'] .icon {color: #6B8E23}
.temperature[data-value='64°'] .icon {color: #6B8E23}
.temperature[data-value='63°'] .icon {color: #6B8E23}
.temperature[data-value='62°'] .icon {color: #6B8E23}
.temperature[data-value='61°'] .icon {color: #6B8E23}
.temperature[data-value='60°'] .icon {color: #6B8E23}
.temperature[data-value='59°'] .icon {color: #6B8E23}
.temperature[data-value='58°'] .icon {color: #00FF7F}
.temperature[data-value='57°'] .icon {color: #00FF7F}
.temperature[data-value='56°'] .icon {color: #00FF7F}
.temperature[data-value='55°'] .icon {color: #00FF7F}
.temperature[data-value='54°'] .icon {color: #00FF7F}
.temperature[data-value='53°'] .icon {color: #00FF7F}
.temperature[data-value='52°'] .icon {color: #00FF7F}
.temperature[data-value='51°'] .icon {color: #00FF7F}
.temperature[data-value='50°'] .icon {color: #00FF7F}
.temperature[data-value='49°'] .icon {color: #66CDAA}
.temperature[data-value='48°'] .icon {color: #66CDAA}
.temperature[data-value='47°'] .icon {color: #66CDAA}
.temperature[data-value='46°'] .icon {color: #66CDAA}
.temperature[data-value='45°'] .icon {color: #66CDAA}
.temperature[data-value='44°'] .icon {color: #66CDAA}
.temperature[data-value='43°'] .icon {color: #66CDAA}
.temperature[data-value='42°'] .icon {color: #66CDAA}
.temperature[data-value='41°'] .icon {color: #66CDAA}
.temperature[data-value='40°'] .icon {color: #00FFFF}
.temperature[data-value='39°'] .icon {color: #00FFFF}
.temperature[data-value='38°'] .icon {color: #00FFFF}
.temperature[data-value='37°'] .icon {color: #00FFFF}
.temperature[data-value='36°'] .icon {color: #00FFFF}
.temperature[data-value='35°'] .icon {color: #00FFFF}
.temperature[data-value='34°'] .icon {color: #00FFFF}
.temperature[data-value='33°'] .icon {color: #00FFFF}
.temperature[data-value='32°'] .icon {color: #00FFFF}
.temperature[data-value='31°'] .icon {color: #00FFFF}
.temperature[data-value='30°'] .icon {color: #00FFFF}
.temperature[data-value='29°'] .icon {color: #00FFFF}
.temperature[data-value='28°'] .icon {color: #00FFFF}
.temperature[data-value='27°'] .icon {color: #00FFFF}
.temperature[data-value='26°'] .icon {color: #00FFFF}
.temperature[data-value='25°'] .icon {color: #00FFFF}
